...
import EditContentItem from "./editcookieitem";
...
const Cookies = () => {
  ...
  const getCookies = e => {
    e.preventDefault();
    fetch("https://admin-dev.rivn.com/cookies", {
      method: "POST",
      headers: {
  ...
  const addNew = e => {
    ...
    newElem.placeholder = "Enter new Cookie ID";
    ...
    <div>
      <div className="form-wrapper">
        <form onSubmit={getCookies}>
          <input
            type="text"
            placeholder="Enter Vendor ID to get Cookies.."
